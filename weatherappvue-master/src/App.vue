<template>
  <div id="main" :class="isDay ? 'day' : 'night'">
    <div class="container my-5">
      ...
      <p class="text-center my-3" v-if="cityFound">
        Please try again, this city is unavailable!
      </p>
      <div
...
export default {
  ...
  methods: {
    getWeather: async function() {
      ...
      const key = "dcbfe397abe18e42f056839590d481d7";
      ...
      try {
        ...
        this.weather.longitude = data.coord.lon;
        this.weather.latitude = data.coord.lat;
        this.weather.windspeedeg = data.wind.deg;
